...
#include "games/game/maps/demo/widgets/HUD.h"
...
I32 bbWidgetFunctions_populate(I32 map){
    ...
    bbWidgetFunctions_add(functions, f_WidgetConstructor, bbWidgetNew_HUD, "HUD");
    ...
    bbWidgetFunctions_add(functions, f_WidgetMouseHandler, bbWidgetClick_HUD, "HUD");
